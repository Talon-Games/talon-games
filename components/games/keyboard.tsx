  ...
  return (
    <div
      className={`${width} ${statusToColor(
        status,
      )} bg-opacity-30 active:border-neutral-400 backdrop-blur-sm text-2xl max-sm:text-xl max-xs:text-lg max-xs:p-1 p-2 border border-neutral-300 rounded flex justify-center items-center cursor-pointer hover:bg-opacity-70 transition-colors ${className}`}

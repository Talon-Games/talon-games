...
export default function GameCard({ game }: { game: Game }) {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center bg-accent-100 rounded-xl p-5 cursor-pointer hover:bg-secondary-100 transition-all duration-200 ease-out"
